...
# 状態を示す文字S0～S8を描く
plt.text(0.5, 2.5, 'S6', size=14, ha='center')
plt.text(1.5, 2.5, 'S7', size=14, ha='center')
plt.text(2.5, 2.5, 'S8', size=14, ha='center')
...
plt.text(2.5, 2.3, 'GOAL', ha='center')
