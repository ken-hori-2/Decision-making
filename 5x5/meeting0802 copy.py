...
ax = axes.ravel()
#p1, = ax[0].plot([], [],'o-',color='C3',alpha=0.5)
#return (line,)
...
line1, = ax[0].plot([1.5], [2.5], marker="*", color='y', markersize=30)
# line.set_data([], [])
# line1.set_data([], [])
ax[0].plot([1.0], [3.5], marker="d", color='r', markersize=20)
ax[0].plot([0.0], [4.5], marker="d", color='r', markersize=20)
ax[0].plot([4.0], [3.5], marker="d", color='b', markersize=20)
ax[0].plot([5.0], [1.5], marker="d", color='b', markersize=20)

# 赤い壁を描く
#plt.plot([1, 1], [0, 1], color='black', linewidth=2)
ax[0].plot([1, 2], [2, 2], color='black', linewidth=2)
#plt.plot([2, 2], [2, 1], color='black', linewidth=2)
#plt.plot([2, 3], [1, 1], color='black', linewidth=2)
ax[0].plot([3, 4], [5, 5], color='black', linewidth=2)

ax[0].plot([2, 3], [3, 3], color='black', linewidth=2)
ax[0].plot([1, 1], [3, 4], color='black', linewidth=2)
#plt.plot([0, 1], [4, 4], color='black', linewidth=2)
ax[0].plot([1, 2], [5, 5], color='black', linewidth=2)

ax[0].plot([2, 2], [4, 5], color='black', linewidth=2)
ax[0].plot([3, 3], [5, 6], color='black', linewidth=2)
ax[0].plot([4, 5], [3, 3], color='black', linewidth=2)
ax[0].plot([2, 3], [1, 1], color='black', linewidth=2)
ax[0].plot([2, 3], [4, 4], color='black', linewidth=2)

ax[0].plot([5, 5], [1, 3], color='black', linewidth=2)
ax[0].plot([5, 6], [1, 1], color='black', linewidth=2)
ax[0].plot([3, 3], [0, 1], color='black', linewidth=2)
ax[0].plot([2, 2], [1, 2], color='black', linewidth=2)


ax[0].plot([4, 4], [2, 3], color='black', linewidth=2)
ax[0].plot([3, 4], [2, 2], color='black', linewidth=2)
ax[0].plot([2, 2], [2, 3], color='black', linewidth=2)
ax[0].plot([4, 4], [3, 4], color='black', linewidth=2)
ax[0].plot([4, 4], [4, 5], color='black', linewidth=2)

ax[0].plot([2, 3], [5, 5], color='black', linewidth=2)
ax[0].plot([5, 5], [1, 2], color='black', linewidth=2)
ax[0].plot([0, 1], [2, 2], color='black', linewidth=2)
ax[0].plot([0, 1], [3, 3], color='black', linewidth=2)

# 状態を示す文字S0～S8を描く
ax[0].text(0.5, 5.5, 'S0', size=14, ha='center')
ax[0].text(1.5, 5.5, 'S1', size=14, ha='center')
ax[0].text(2.5, 5.5, 'S2', size=14, ha='center')
ax[0].text(3.5, 5.5, 'S3', size=14, ha='center')
ax[0].text(4.5, 5.5, 'S4', size=14, ha='center')
ax[0].text(5.5, 5.5, 'S5', size=14, ha='center')
ax[0].text(0.5, 4.5, 'S6', size=14, ha='center')
ax[0].text(1.5, 4.5, 'S7', size=14, ha='center')
ax[0].text(2.5, 4.5, 'S8', size=14, ha='center')
ax[0].text(3.5, 4.5, 'S9', size=14, ha='center')
ax[0].text(4.5, 4.5, 'S10', size=14, ha='center')
ax[0].text(5.5, 4.5, 'S11', size=14, ha='center')
ax[0].text(0.5, 3.5, 'S12', size=14, ha='center')
ax[0].text(1.5, 3.5, 'S13', size=14, ha='center')
ax[0].text(2.5, 3.5, 'S14', size=14, ha='center')
ax[0].text(3.5, 3.5, 'S15', size=14, ha='center')

ax[0].text(4.5, 3.5, 'S16', size=14, ha='center')
ax[0].text(5.5, 3.5, 'S17', size=14, ha='center')
ax[0].text(0.5, 2.5, 'S18', size=14, ha='center')
ax[0].text(1.5, 2.5, 'S19', size=14, ha='center')
ax[0].text(2.5, 2.5, 'S20', size=14, ha='center')
ax[0].text(3.5, 2.5, 'S21', size=14, ha='center')
ax[0].text(4.5, 2.5, 'S22', size=14, ha='center')
ax[0].text(5.5, 2.5, 'S23', size=14, ha='center')
ax[0].text(0.5, 1.5, 'S24', size=14, ha='center')
ax[0].text(1.5, 1.5, 'S25', size=14, ha='center')
ax[0].text(2.5, 1.5, 'S26', size=14, ha='center')
ax[0].text(3.5, 1.5, 'S27', size=14, ha='center')
ax[0].text(4.5, 1.5, 'S28', size=14, ha='center')
ax[0].text(5.5, 1.5, 'S29', size=14, ha='center')
ax[0].text(0.5, 0.5, 'S30', size=14, ha='center')
ax[0].text(1.5, 0.5, 'S31', size=14, ha='center')

ax[0].text(2.5, 0.5, 'S32', size=14, ha='center')
ax[0].text(3.5, 0.5, 'S33', size=14, ha='center')
ax[0].text(4.5, 0.5, 'S34', size=14, ha='center')
ax[0].text(5.5, 0.5, 'S35', size=14, ha='center')


ax[0].text(2.5, 3.3, 'STATE0', ha='center')
...
def animate(i):
    ...
    if len(imgs)>0:
        imgs.pop().remove()
    H, xedge, yedge = np.histogram2d(X[:i+1], Y[:i+1],bins=(xedges, yedges))
    img = ax[1].imshow(H.T, interpolation='nearest', origin='lower',
