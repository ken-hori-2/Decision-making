        ...
        if num[j]==3:
            if S == False:
                ...
                if r1 == 1:
                    ...
                    s_next = s
                    state_history.append(s_next)
                    AAA(s_next,depth+1,i+1,j+1,S,S2)
                state_history.append(s_next)
                state_history.append(s_next)    #追加した場所
                #####
                s_next = s
                state_history.append(s_next)
                AAA(s_next,depth,i+1,j,S,S2)
            if S == False:
                s_next = s - 2
                #depth = num[j]
                #j -= 1
                ...
                s_next = s
                state_history.append(s_next)
                AAA(s_next,depth+2,i+2,j+1,S,S2)
...
def animate(i):
    ...
    if state == 3 and state_history[i-1]==4:
