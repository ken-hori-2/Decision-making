...
def AAA(s,depth,i,j,S,S2,S3,S4,judge1,judge2,judge3,judge4):
        ...
        if num[j]==3:
            if S == False and S2 == False:
                ...
                if r1 == 1:
                    ...
                    state_history.append(s_next)
                    depth = 0
                    AAA(s_next,depth+1,i+1,j+1,S,S2,S3,S4,judge1,judge2,judge3,judge4)
                else:
                    print('r1 = False')
                    S2 = True
    ...
    return state_history,S,S2,S3,S4,judge1,judge2,judge3,judge4
...
# judge3 = False
# judge4 = False
def AAA_top(s,depth,i,j,S,S2,S3,S4,judge1,judge2,judge3,judge4):
    # i = 0
    # j = 0
    # depth = 0
...
def goal_maze(pi):
    ...
    state_history,S,S2,S3,S4,judge1,judge2,judge3,judge4 = AAA_top(s,0,i,j,S,S2,S3,S4,judge1,judge2,judge3,judge4)
    
    return state_history,S,S2,S3,S4,judge1,judge2,judge3,judge4


# 迷路内をゴールを目指して、移動
state_history,S,S2,S3,S4,judge1,judge2,judge3,judge4 = goal_maze(pi_0)
...
def animate(i):
    ...
    if state == 3 and state_history[i-1]==4 and judge1 == True:
        ...
        line1.set_data(x+0.2,y)
    elif state == 5 and state_history[i-1]==6:
