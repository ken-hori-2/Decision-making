...
def AAA(s):
    ...
    if next_direction == "up":
        if A[s-4] < 2:
            ...
            AAA(s_next)
        elif AA[s][1]==1 or AA[s][2]==1 or AA[s][3]==1:
            #pass #AAA(s)
            while next_direction == "up":
                next_direction = np.random.choice(direction, p=PI[s, :])
            if next_direction == "down":
                if A[s+4] < 2:
                    ...
                    while next_direction == "down" or next_direction == "up":
                        next_direction = np.random.choice(direction, p=PI[s, :])
                    if next_direction == "right":
                        if A[s+1] < 2:
                            ...
                            while next_direction == "down" or next_direction == "up" or next_direction == "right":
                                next_direction = np.random.choice(direction, p=PI[s, :])
                    ...
                    if next_direction == "left":
                        if A[s-1] < 2:
                            ...
                            while next_direction == "down" or next_direction == "up" or next_direction == "left":
                                next_direction = np.random.choice(direction, p=PI[s, :])
                            if next_direction == "right":
                                if A[s+1] < 2:
                                    s_next = s + 1  # 右に移動するときは状態の数字が1大きくなる
    ...
    if next_direction == "right":
        if A[s+1] < 2:
           ...
           state_history.append(s_next)
           AAA(s_next)
        elif AA[s][0]==1 or AA[s][2]==1 or AA[s][3]==1:
            #pass #AAA(s)
            print('right_elif')
            while next_direction == "right":
                next_direction = np.random.choice(direction, p=PI[s, :])
                print('next_direction:{}'.format(next_direction))
            if next_direction == "up":
                if A[s-4] < 2:
                    s_next = s - 4  # 上に移動するときは状態の数字が3小さくなる
                    state_history.append(s_next)
                    ...
                    while next_direction == "right" or next_direction == "up":
                        next_direction = np.random.choice(direction, p=PI[s, :])
                    if next_direction == "down":
                        if A[s+4] < 2:
                            s_next = s + 4  # 右に移動するときは状態の数字が1大きくなる
                            state_history.append(s_next)
                            AAA(s_next)
                        else:
                            while next_direction == "right" or next_direction == "up" or next_direction == "down":
                                next_direction = np.random.choice(direction, p=PI[s, :])
                            if next_direction == "left":
                                if A[s-1] < 2:
                                    s_next = s - 1  # 左に移動するときは状態の数字が1小さくなる
                    ...
                    if next_direction == "left":
                        if A[s-1] < 2:
                            ...
                            while next_direction == "right" or next_direction == "up" or next_direction == "left":
                                next_direction = np.random.choice(direction, p=PI[s, :])
                            if next_direction == "down":
                                if A[s+4] < 2:
                                    s_next = s + 4  # 右に移動するときは状態の数字が1大きくなる
    ...
    if next_direction == "down":
        if A[s+4] < 2:
            ...
            state_history.append(s_next)
            AAA(s_next)
        elif AA[s][0]==1 or AA[s][1]==1 or AA[s][3]==1:
            #AAA(s)
            print('down_elif')
            while next_direction == "down":
                next_direction = np.random.choice(direction, p=PI[s, :])
                print('next_direction:{}'.format(next_direction))
            if next_direction == "up":
                if A[s-4] < 2:
    ...
    if next_direction == "left":
        if A[s-1] < 2:
            ...
            state_history.append(s_next)
            AAA(s_next)
        elif AA[s][0]==1 or AA[s][1]==1 or AA[s][2]==1:
            #pass #AAA(s)
            print('left_elif')
            while next_direction == "left":
                next_direction = np.random.choice(direction, p=PI[s, :])
                print('next_direction:{}'.format(next_direction))
            ...
            if next_direction == "up":
                if A[s-4] < 2:
                    ...
                    while next_direction == "left" or next_direction == "up":
                        next_direction = np.random.choice(direction, p=PI[s, :])
                    if next_direction == "right":
                        if A[s+1] < 2:
                            s_next = s + 1  # 右に移動するときは状態の数字が1大きくなる
                            ...
                            while next_direction == "left" or next_direction == "up" or next_direction == "right":
                                next_direction = np.random.choice(direction, p=PI[s, :])
                            if next_direction == "down":
                                if A[s+4] < 2:
                                    s_next = s + 4  # 左に移動するときは状態の数字が1小さくなる
                                    state_history.append(s_next)
                                    AAA(s_next)              
                    if next_direction == "down":
                        if A[s+4] < 2:
                            ...
                            while next_direction == "left" or next_direction == "up" or next_direction == "down":
                                next_direction = np.random.choice(direction, p=PI[s, :])
                            if next_direction == "right":
                                if A[s+1] < 2:
                                    s_next = s + 1  # 右に移動するときは状態の数字が1大きくなる
...
def get_next_s(pi, s):
    ...
    while(1):
        ...
        #if A[s-4]<2 or A[s+1]<2 or A[s+4]<2 or A[s-1]<2:
        ...
        if next_direction == "up":
            ...
            if A[s_next] < 2:
                ...
                s_next = s
                if A[s-4] == 2 :
                    if AA[s][0]+AA[s][1]+AA[s][2]+AA[s][3] <= 1:
