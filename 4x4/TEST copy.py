...
class track(state_history):

    def __init__(self):
        self.anim = animation.FuncAnimation(fig, self.animate(), init_func=self.ini(), frames=len(
