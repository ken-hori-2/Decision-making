...
line2, = ax.plot([1.5], [2.5], marker="*", color='r', markersize=30)
#X = [0.]*20
#Y = [0.]*20
X = [0.]*1000
Y = [0.]*1000
...
def animate(i):
    ...
    x2 = (state % 4) + 0.5  # 状態のx座標は、3で割った余り+0.5
    y2 = 3.5 - int(state / 4)  # y座標は3で割った商を2.5から引く
    X[i] = x2
    Y[i] = y2
    ...
    #line2.set_data(X[a], Y[a])


    #if A[state] == 1:
    #    ax.plot([x], [y], marker="*", color='y', markersize=30)
    ...
    #    line1.set_data(x2,y2)
        #line1, = ax.plot([x], [y], marker="*", color='y', markersize=30)
    #if A[state2] == 2:
    #    line2.set_data(x2,y2)
        #line1, = ax.plot([x], [y], marker="*", color='g', markersize=30)
    ###################################################################################################

    #if A[state2] ==1:
        #line1.set_data(x2,y2)
    #    pass#line1, = ax.plot([x], [y], marker="*", color='y', markersize=30)
