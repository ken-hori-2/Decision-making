        ...
        if A[s-4] < 2:
            ...
            if next_direction == "down":
                if A[s+4] < 2:
                    ...
                    while next_direction != "down" and next_direction != "up":
                        next_direction = np.random.choice(direction, p=PI[s, :])
                    if next_direction == "right":
                        if A[s+1] < 2:
                            ...
                            while next_direction != "down" and next_direction != "up" and next_direction != "right":
                                next_direction = np.random.choice(direction, p=PI[s, :])
                    ...
                    if next_direction == "left":
                        if A[s-1] < 2:
                            ...
                            while next_direction != "down" and next_direction != "up" and next_direction != "left":
                                next_direction = np.random.choice(direction, p=PI[s, :])
                            if next_direction == "right":
                                if A[s+1] < 2:
                                    s_next = s + 1  # 右に移動するときは状態の数字が1大きくなる
           ...
           AAA(s_next)
            ...
            if next_direction == "up":
                if A[s-4] < 2:
                    ...
                    while next_direction != "right" and next_direction != "up":
                        next_direction = np.random.choice(direction, p=PI[s, :])
                    if next_direction == "down":
                        if A[s+4] < 2:
                            ...
                            while next_direction != "right" and next_direction != "up" and next_direction != "down":
                                next_direction = np.random.choice(direction, p=PI[s, :])
                            if next_direction == "left":
                                if A[s-1] < 2:
                                    s_next = s - 1  # 左に移動するときは状態の数字が1小さくなる
                    ...
                    if next_direction == "left":
                        if A[s-1] < 2:
                            ...
                            while next_direction != "right" and next_direction != "up" and next_direction != "left":
                                next_direction = np.random.choice(direction, p=PI[s, :])
                            if next_direction == "down":
                                if A[s+4] < 2:
                                    s_next = s + 4  # 右に移動するときは状態の数字が1大きくなる
        ...
        if A[s-1] < 2:
            ...
            if next_direction == "up":
                if A[s-4] < 2:
                    ...
                    while next_direction != "left" and next_direction != "up":
                        next_direction = np.random.choice(direction, p=PI[s, :])
                    if next_direction == "right":
                        if A[s+1] < 2:
                            s_next = s + 1  # 右に移動するときは状態の数字が1大きくなる
                            ...
                            while next_direction != "left" and next_direction != "up" and next_direction != "right":
                                next_direction = np.random.choice(direction, p=PI[s, :])
                            if next_direction == "down":
                                if A[s+4] < 2:
                    ...
                    if next_direction == "down":
                        if A[s+4] < 2:
                            ...
                            while next_direction != "left" and next_direction != "up" and next_direction != "down":
                                next_direction = np.random.choice(direction, p=PI[s, :])
                            if next_direction == "right":
                                if A[s+1] < 2:
                                    s_next = s + 1  # 右に移動するときは状態の数字が1大きくなる
