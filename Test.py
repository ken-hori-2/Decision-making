...
def animate(i):
    ...
    elif state == 2 and state_history[i-1]==4 and judge2 == True:
        line1.set_data(x+0.2,y)
    elif state == 5 and state_history[i-1]==6 and judge3 == True:
        line2.set_data(x+0.2,y)
    elif state == 4 and state_history[i-1]==6 and judge4 == True:
        line2.set_data(x+0.2,y)
    else:
